...
########################################################
"""
Le Lanceur permet de lancer le jeu
"""
########################################################
...
class Lanceur():
    def __init__(self):
        ...
        self.default_options={'N': '5', 'M': '5', 'ticks_day': '150', 'energy_food': '100', 'foods_jour': '2', 'nb_bobs': '1', 'eSpawn': '100', 'eMax': '200', 'eMother': '150', 'eBirth': '50',"e_SR":'150',"eBirth_SR":"100", 'Mutv': '0', 'Mut_m': '0.1', 'Mut_p': '1', 'Mut_mem': '1', 'velocity': '1', 'mass': '1', 'perception_score': '6', 'initial_memory_points': '0', 'reproduction_parthenogenese_activation': True, "age":False, "reproduction_sexuelle_activation":False}
    ...
    def fonction(self, screen):
        ...
        while running:
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    print("on stop game dans le lanceur")
                    self.jeu.interface.stop_game()
                    running = False
